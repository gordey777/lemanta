...
(function(d) {
  ...
  i.prototype = {
    ...
    initialize: function() {
      ...
      d('<div id="' + this.mainContainerId + '" class="autocomplete-cont"><div class="autocomplete-w1"><div class="autocomplete" id="' + c + '"></div></div></div>').appendTo("body");
      this.container = d("#" + c);
      this.fixPosition();
    ...
    fixPosition: function() {
      ...
      d("#" + this.mainContainerId).css({
        top: b.top + this.el.innerHeight() + 10 +"px",
        left: b.left + "px"
      })
    },
