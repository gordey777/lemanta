...
images/FB-f-Logo__blue_29.png" alt="Lemanta в Facebook" /></a></div><?php if (!empty($_smarty_tpl->tpl_vars['currencies']->value)&&count($_smarty_tpl->tpl_vars['currencies']->value)>1){?><div class="valuta col-md-2"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['echoVar'][0][0]->echoVar(array('from'=>'currency->currency_id','assign'=>'sid'),$_smarty_tpl);?>
...
</a><?php } ?><form id="currencyForm" method="post"><input id="currencyFormInput" name="currency_id" type="hidden" value="" /></form></div><!-- /.valuta --><?php }?></div></div><!-- /.row --></div><!-- /.container --></div><!-- /.top-menu-wrap --><div class="container"><div class="row"><div class="logo col-md-2 col-sm-2 col-xs-2"><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['site'][0][0]->site(array(),$_smarty_tpl);?>
...
</div><?php }?><?php }?><?php }?></div><!-- /.seo-container col-md-12 --></div><!-- /.row --></div><!-- /.container --></section><!-- /section --></div><!-- /wrapper --><footer class="footer"><div class="container"><div class="row"><div class="col-md-12"><?php if ($_smarty_tpl->tpl_vars['onFirstPage']->value){?><?php if (!empty($_smarty_tpl->tpl_vars['seo']->value[1]['body'])&&!empty($_smarty_tpl->tpl_vars['seo']->value[2]['body'])){?><a class="seo-link" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['requestUri'][0][0]->requestUri(array(),$_smarty_tpl);?>
