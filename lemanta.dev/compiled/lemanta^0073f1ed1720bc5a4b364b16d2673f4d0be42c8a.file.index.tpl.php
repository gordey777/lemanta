<?php /* Smarty version Smarty-3.1.8, created on 2016-11-08 17:18:12
...
</div></div></div><!-- /.row --></div><!-- /.container --></footer><a id="back-top" title="К началу страницы"><i class="fa fa-arrow-up"></i></a><!-- ===========================================================|                                                                 ||  Скрипты.                                                       ||                                                                 |============================================================ -->*}<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script><script>var thisTemplateRootUrl = '<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['theme'][0][0]->theme(array(),$_smarty_tpl);?>
