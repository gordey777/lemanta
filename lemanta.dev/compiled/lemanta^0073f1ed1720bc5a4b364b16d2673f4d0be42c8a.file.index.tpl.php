<?php /* Smarty version Smarty-3.1.8, created on 2016-11-10 18:34:43
...
</p><?php }?></div><?php }?></li><?php endfor; endif; ?></ul></div><?php }?><!-- wrapper --><div class="bg wrapper"><header role="banner"><a href="#mob-menu" id="hamburger" class="humb-toggle-switch humb-toggle-switch__htx"><span>toggle menu</span></a><div class="top-menu-wrap"><div class="container"><div class="row"><div class="top-menu col-md-12"><div class="login col-md-2 col-xs-5"><?php if (!empty($_smarty_tpl->tpl_vars['user']->value)){?><span id="username"><a href="account" rel="nofollow"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['echoVar'][0][0]->echoVar(array('from'=>'user->compound_name'),$_smarty_tpl);?>
...
images/FB-f-Logo__blue_29.png" alt="Lemanta в Facebook" /></a></div><?php if (!empty($_smarty_tpl->tpl_vars['currencies']->value)&&count($_smarty_tpl->tpl_vars['currencies']->value)>1){?><div class="valuta col-md-4 col-xs-6"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['echoVar'][0][0]->echoVar(array('from'=>'currency->currency_id','assign'=>'sid'),$_smarty_tpl);?>
...
</a><?php } ?><form id="currencyForm" method="post"><input id="currencyFormInput" name="currency_id" type="hidden" value="" /></form></div><!-- /.valuta --><?php }?></div></div><!-- /.row --></div><!-- /.container --></div><!-- /.top-menu-wrap --><div class="container"><div class="row"><div class="logo col-md-2 col-sm-2 col-xs-4"><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['site'][0][0]->site(array(),$_smarty_tpl);?>
