<?php /* Smarty version Smarty-3.1.8, created on 2016-11-09 21:51:51
...
</p><?php }?></div><?php }?></li><?php endfor; endif; ?></ul></div><?php }?><!-- wrapper --><div class="bg wrapper"><header role="banner"><a href="#mob-menu" id="hamburger" class="humb-toggle-switch humb-toggle-switch__htx"><span>toggle menu</span></a><nav id="mob-menu"><ul class="mob-menu"><!--         <li><a id="mob-search" class="search"><form method="post" onsubmit="return false"><input class="input_search" name="keyword" maxlength="48" type="text" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['inputValue'][0][0]->inputValue(array('from'=>'keyword'),$_smarty_tpl);?>
...
</ul></nav><div class="top-menu-wrap"><div class="container"><div class="row"><div class="top-menu col-md-12"><div class="login col-md-2 col-xs-5"><?php if (!empty($_smarty_tpl->tpl_vars['user']->value)){?><span id="username"><a href="account" rel="nofollow"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['echoVar'][0][0]->echoVar(array('from'=>'user->compound_name'),$_smarty_tpl);?>
