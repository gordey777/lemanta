<?php /* Smarty version Smarty-3.1.8, created on 2016-11-22 15:14:20
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '57865826ebeb3fd889-39675387',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_5826ebeb546292_03544122',
  'variables' => 
  array (
    'uri' => 0,
    'ajax' => 0,
...
<?php if ($_valid && !is_callable('content_5826ebeb546292_03544122')) {function content_5826ebeb546292_03544122($_smarty_tpl) {?>
<?php echo $_smarty_tpl->getSubTemplate ('common/check404.htm', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
css/style.css" rel="stylesheet" /></head><?php if ($_smarty_tpl->tpl_vars['onFirstPage']->value){?><body class="home-page"><?php }elseif(!empty($_smarty_tpl->tpl_vars['category']->value)){?><body class="category-page"><?php }elseif(!empty($_smarty_tpl->tpl_vars['section']->value)){?><body class="section-page"><?php }elseif(!empty($_smarty_tpl->tpl_vars['user']->value)){?><body class="user-page"><?php }elseif(!empty($_smarty_tpl->tpl_vars['brand']->value)){?><body class="brand-page"><?php }elseif(!empty($_smarty_tpl->tpl_vars['product']->value)){?><body class="product-page"><?php }elseif(!empty($_smarty_tpl->tpl_vars['item']->value)){?><body class="item-page"><?php }elseif(!empty($_smarty_tpl->tpl_vars['group']->value)){?><body class="group-page"><?php }elseif(!empty($_smarty_tpl->tpl_vars['emulator']->value)){?><body class="emulator-page"><?php }else{ ?><body class="other-page"><?php }?><?php $_smarty_tpl->tpl_vars['mod'] = new Smarty_variable('mod-google-tag-manager.htm', null, 0);?><?php if ($_smarty_tpl->tpl_vars['emulator']->value->existsModule($_smarty_tpl->tpl_vars['mod']->value)){?><?php echo $_smarty_tpl->getSubTemplate (($_smarty_tpl->tpl_vars['mod']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('trackOrder'=>true,'baseOnly'=>true,'trackCart'=>true,'trackDefer'=>true,'startManager'=>true,'gtmID'=>'GTM-TQKHLJ','final'=>true), 0);?>
...
</p><?php }?></div><?php }?></li><?php endfor; endif; ?></ul></div><?php }?><!-- wrapper --><div id="wrapper" class="bg wrapper"><header class="header" role="banner"><a href="#mob-menu" id="hamburger" class="humb-toggle-switch humb-toggle-switch__htx"><span>toggle menu</span></a><div class="top-menu-wrap"><div class="container"><div class="row"><div class="top-menu col-md-12"><div class="login col-md-2 col-sm-3 col-xs-8"><?php if (!empty($_smarty_tpl->tpl_vars['user']->value)){?><span id="username"><a href="account" rel="nofollow"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['echoVar'][0][0]->echoVar(array('from'=>'user->compound_name'),$_smarty_tpl);?>
...
images/FB-f-Logo__blue_29.png" alt="Lemanta в Facebook" /></a></div><?php if (!empty($_smarty_tpl->tpl_vars['currencies']->value)&&count($_smarty_tpl->tpl_vars['currencies']->value)>1){?><div class="valuta col-md-3 col-md-offset-4 col-sm-4 col-xs-4"><ul class="valuta-list"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['echoVar'][0][0]->echoVar(array('from'=>'currency->currency_id','assign'=>'sid'),$_smarty_tpl);?>
...
images/logo.png" alt="" /></a></div><div id="cart_informer" class="head-cart col-md-3 col-md-offset-5 col-sm-4 col-xs-5"><?php echo $_smarty_tpl->getSubTemplate ('common/cart-informer.htm', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
</a><?php $_smarty_tpl->tpl_vars['number'] = new Smarty_variable($_smarty_tpl->tpl_vars['number']->value+1, null, 0);?><?php } ?><?php }?><div class="lenta"><p>Топ продаж</p></div></div></li><?php } ?></ul></div><div class="clr"></div><a href="#" class="prev prev-navigation"></a><a href="#" class="next next-navigation"></a></div><?php }?></div><?php }?><section role="main"><div class="container"><div class="row"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['content'][0][0]->content(array(),$_smarty_tpl);?>
...
</div><?php }?><?php }?><?php }?></div><!-- /.seo-container col-md-12 --></div><!-- /.row --></div><!-- /.container --></section><!-- /section --><nav id="mob-menu"><ul class="mob-menu"><!--         <li><a id="mob-search" class="search"><form method="post" onsubmit="return false"><input class="input_search" name="keyword" maxlength="48" type="text" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['inputValue'][0][0]->inputValue(array('from'=>'keyword'),$_smarty_tpl);?>
...
" title="Интернет-магазин одежды от производителя" alt="Интернет-магазин одежды в розницу"><i class="fa fa-home"></i></a></li> --><?php echo $_smarty_tpl->getSubTemplate ('common/mob-menu-catalog.htm', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
</ul></nav><!-- #mob-menu --><footer class="footer"><?php if ($_smarty_tpl->tpl_vars['onFirstPage']->value){?><?php if (!empty($_smarty_tpl->tpl_vars['seo']->value[1]['body'])&&!empty($_smarty_tpl->tpl_vars['seo']->value[2]['body'])){?><a class="seo-link" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['requestUri'][0][0]->requestUri(array(),$_smarty_tpl);?>
...
</div></footer><a id="back-top" title="К началу страницы"><i class="fa fa-arrow-up"></i></a></div><!-- /wrapper --><script>var thisTemplateRootUrl = '<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['theme'][0][0]->theme(array(),$_smarty_tpl);?>
...
js/jquery.mmenu.all.min.js"></script><script type="text/javascript">jQuery(document).ready(function($) {$("#mob-menu").mmenu({"extensions": ["pagedim-black"],"offCanvas": {"position": "right"},navbar: {title: 'LEMANTA'},"navbars": [{"position": "bottom","content": ["<a class='fa fa-skype' href='skype:lemanta2014?call'></a>","<a class='fa fa-vk' href='http://vkontakte.ru/share.php?url=http://lemanta.com'></a>","<a class='fa fa-instagram' href='https://www.instagram.com/lemanta8465/'></a>","<a class='fa fa-facebook' href='https://www.facebook.com/Lemanta-280572415630549//'></a>"]}]});});</script><script type="text/javascript" >$(document).ready(function(){$("#left_menu li a.selected").parents("li").addClass('open').children('ul').slideDown();$("#left_menu li a.selected").parent("li").addClass('bg-selected');if ($("#left_menu li").hasClass('open')) {$("#left_menu li.open").children('.holder').addClass('holder-open');}var holderelement = $('#left_menu li.has-sub>.holder');holderelement.on('click', function(){var element = $(this).parent('li');if (element.hasClass('open')) {element.removeClass('open');$(this).removeClass('holder-open');element.find('li').removeClass('open');element.find('ul').slideUp();}else {element.addClass('open');element.children('ul').slideDown();element.siblings('li').children('ul').slideUp();element.siblings('li').removeClass('open');element.siblings('li').find('li').removeClass('open');element.siblings('li').find('ul').slideUp();$(this).addClass('holder-open');element.siblings('li').find('.holder').removeClass('holder-open');}});});</script><script type="text/javascript" >$(document).ready(function(){var $prodBlW = $(".content .product-block").width(),$prodImgH = ($prodBlW * 1.95),$prodBlH = ($prodBlW * 1.7);$(".content .product-image").css('height',$prodImgH);$(".content .product-img").css('height',$prodBlH);});</script><script src="//vk.com/js/api/openapi.js?105"></script><script>$(document).ready(function(){if($("#vk_groups_widjet").length>0) {var $vkWidth = ($("#vk_groups_widjet").width())*0.9;VK.Widgets.Group('vk_groups', { mode: 0,width: $vkWidth,height: '260',color1: 'FFFFFF',color2: 'BBBBBB',color3: '88BBEE' },'<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['inputValue'][0][0]->inputValue(array('from'=>'config->vk_group'),$_smarty_tpl);?>
');}});</script></body></html><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['headerLastModified'][0][0]->headerLastModified(array(),$_smarty_tpl);?>
