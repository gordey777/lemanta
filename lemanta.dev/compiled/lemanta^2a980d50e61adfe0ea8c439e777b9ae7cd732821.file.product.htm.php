...
" width="52" /></span></a><?php $_smarty_tpl->tpl_vars['number'] = new Smarty_variable($_smarty_tpl->tpl_vars['number']->value+1, null, 0);?><?php endfor; endif; ?><?php }?></div><?php }?><div class="product-image2 col-xs-9"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['findImage'][0][0]->findImage(array('from'=>'product','type'=>'product','num'=>2,'assign'=>'image'),$_smarty_tpl);?>
...
</li><?php } ?></ul><div class="clr"></div></div></div><?php }?></div><!-- .product-info --></div><!-- .product-page --><?php if (!empty($_smarty_tpl->tpl_vars['recent_products']->value)){?><hr class="separator" /><div class="product-rel recent col-md-12"><div class="product-rel-t">ВЫ НЕДАВНО СМОТРЕЛИ</div><div class="product-rel-arr"><a href="#" class="prev prevv"></a><a href="#" class="next nextt"></a></div><div class="clr"></div><div class="cat"><ul><?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
