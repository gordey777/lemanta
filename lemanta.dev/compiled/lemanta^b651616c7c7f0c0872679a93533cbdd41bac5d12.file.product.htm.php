<?php /* Smarty version Smarty-3.1.8, created on 2016-09-11 22:59:24
         compiled from "design/lemanta/html/product.htm" */ ?>
<?php /*%%SmartyHeaderCode:145301328457d5b79cef81b0-25334076%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b651616c7c7f0c0872679a93533cbdd41bac5d12' => 
    array (
  ...
  'nocache_hash' => '145301328457d5b79cef81b0-25334076',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57d5b79d099857_00544963',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57d5b79d099857_00544963')) {function content_57d5b79d099857_00544963($_smarty_tpl) {?><?php if (!empty($_REQUEST['dynamic'])){?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['lastTemplate'][0][0]->lastTemplate(array(),$_smarty_tpl);?>
...
<div class="right no-flex"><div class="product-page"><div class="product-info"><div class="product-left-wrapper"><div class="product-left"><div class="product-image2"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['findImage'][0][0]->findImage(array('from'=>'product','type'=>'product','num'=>2,'assign'=>'image'),$_smarty_tpl);?>
...
" /></a><div class="video-box" style="display: none;"></div></div><?php $_smarty_tpl->tpl_vars['video'] = new Smarty_variable('', null, 0);?><?php if (!empty($_smarty_tpl->tpl_vars['product']->value->files)){?><?php $_smarty_tpl->_capture_stack[0][] = array('default', 'video', null); ob_start(); ?><?php $_smarty_tpl->tpl_vars['number'] = new Smarty_variable(1, null, 0);?><?php  $_smarty_tpl->tpl_vars['file'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['file']->_loop = false;
...
images/video-icon.png" alt="" width="52" /></span></a><?php $_smarty_tpl->tpl_vars['number'] = new Smarty_variable($_smarty_tpl->tpl_vars['number']->value+1, null, 0);?><?php }?><?php } ?><?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php }?><?php if (!empty($_smarty_tpl->tpl_vars['video']->value)||count($_smarty_tpl->tpl_vars['product']->value->images)>1){?><div class="thumb-title">Все фотографии</div><div class="thumb"><?php if (!empty($_smarty_tpl->tpl_vars['video']->value)){?><?php echo $_smarty_tpl->tpl_vars['video']->value;?>
...
" class="cloud-zoom-gallery active" onmouseenter="showZOOMimage(this)" rel="useZoom: 'zoom1', smallImage: '<?php echo $_smarty_tpl->tpl_vars['image']->value['url'];?>
'"><span><img src="<?php echo $_smarty_tpl->tpl_vars['image']->value['thumb'];?>
" alt="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['image']->value['alt'], ENT_QUOTES, 'UTF-8');?>
" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['image']->value['desc'], ENT_QUOTES, 'UTF-8');?>
" width="52" /></span></a><?php $_smarty_tpl->tpl_vars['number'] = new Smarty_variable($_smarty_tpl->tpl_vars['number']->value+1, null, 0);?><?php endfor; endif; ?><?php }?></div><?php }?></div></div><div class="clr"></div></div><div class="product-right"><h1><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['name'][0][0]->name(array('from'=>'product'),$_smarty_tpl);?>
...
images/icon4.png" alt="" /></a></div><div class="clr"></div><?php if (!empty($_smarty_tpl->tpl_vars['product']->value->tags)){?><br /><p class="tags"><?php echo $_smarty_tpl->tpl_vars['product']->value->tags;?>
</p><?php }?></div><div class="clr"></div></div><div class="product-more-info"><div class="product-desc"><div class="desc-menu"><a class="active" onclick="switchDescriptionTab(this, 'desc-info')">Описание</a><?php if (!empty($_smarty_tpl->tpl_vars['product']->value->video)){?><a onclick="switchDescriptionTab(this, 'desc-video')">Видео</a><?php }?></div><div class="desc-data"><div class="desc-info"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['body'][0][0]->body(array('from'=>'product'),$_smarty_tpl);?>
...
</li><?php } ?></ul><div class="clr"></div></div></div><?php }?></div><?php if (!empty($_smarty_tpl->tpl_vars['recent_products']->value)){?><hr class="separator" /><div class="product-rel"><div class="product-rel-t">ВЫ НЕДАВНО СМОТРЕЛИ</div><div class="product-rel-arr"><a href="#" class="prev prevv"></a><a href="#" class="next nextt"></a></div><div class="clr"></div><div class="cat"><ul><?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['recent_products']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value){
$_smarty_tpl->tpl_vars['item']->_loop = true;
?><li><?php echo $_smarty_tpl->getSubTemplate ('common/product-card.htm', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
</li><?php } ?></ul><div class="clr"></div></div></div><?php }?></div></div><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['discountPrice'][0][0]->discountPrice(array('from'=>'product','signed'=>false,'assign'=>'price'),$_smarty_tpl);?>
