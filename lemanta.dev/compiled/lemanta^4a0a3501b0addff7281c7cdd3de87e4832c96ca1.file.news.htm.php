<?php /* Smarty version Smarty-3.1.8, created on 2016-11-08 18:14:09
...
<?php }?><article class="content col-md-9 col-sm-9 col-md-push-3 col-sm-push-3"><div class="right"><?php if (!empty($_smarty_tpl->tpl_vars['all_news']->value)){?><div class="blog-page"><?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
...
</div><?php }else{ ?><p>Новости не найдены.</p><?php }?></div></article><!-- .content --><?php echo $_smarty_tpl->getSubTemplate ('common/left-column.htm', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
