<?php /* Smarty version Smarty-3.1.8, created on 2016-11-08 18:19:42
...
<?php }?><article class="content col-md-9 col-sm-9 col-md-push-3 col-sm-push-3"><div class="right col-md-6"><?php if (!empty($_smarty_tpl->tpl_vars['feedback_accepted']->value)){?><p><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['echoVar'][0][0]->echoVar(array('from'=>'feedback_message'),$_smarty_tpl);?>
...
</div><!-- /.right --><div class="col-md-6"><form class="form feedback_form register_form login_form" method="post"><?php if (!empty($_smarty_tpl->tpl_vars['feedback_error']->value)){?><div class="message_error"><?php echo $_smarty_tpl->tpl_vars['feedback_error']->value;?>
...
" /></form><?php }?></div></article><!-- .content --><?php echo $_smarty_tpl->getSubTemplate ('common/left-column.htm', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
