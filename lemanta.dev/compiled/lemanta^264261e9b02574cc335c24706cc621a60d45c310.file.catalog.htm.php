<?php /* Smarty version Smarty-3.1.8, created on 2016-11-03 16:23:09
...
Smarty::$global_tpl_vars['enableHitProducts'] = clone $_smarty_tpl->tpl_vars['enableHitProducts'];?><div id="main_page_bloks"><h1>CATALOG</h1><div class="block-main"><div class="tel"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['echoVar'][0][0]->echoVar(array('from'=>'config->phone1'),$_smarty_tpl);?>
...
images/main3.png" alt="" /></a><div class="main-img-txt item3"><p>Новости</p></div></div><div class="line2"></div><div class="desc"><h3>Доставка</h3><p>Доставка осуществляется курьерской службой <span>"Новая Почта"</span>. Сроки доставки 1-3 дня. По прибытию товара Вы будете уведомлены СМС сообщением.</p></div></div></div>
<?php }} ?>