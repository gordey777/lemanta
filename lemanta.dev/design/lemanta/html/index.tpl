...
<!--         <li>
    ...
    <script type="text/javascript" >
        ...
        $('#left_menu > li:has(ul)').addClass("has-sub");
...
$('#left_menu li.has-sub>a').on('click', function(){
  ...
  (function getColor() {
    ...
    if (l > 0.7) {
      $('#left_menu>ul>li>a').css('text-shadow', '0 1px 1px rgba(0, 0, 0, .35)');
      $('#left_menu>ul>li>a>span').css('border-color', 'rgba(0, 0, 0, .35)');
    }
    else
    {
      $('#left_menu>ul>li>a').css('text-shadow', '0 1px 0 rgba(255, 255, 255, .35)');
