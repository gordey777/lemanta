    ...
    * Copyright (c) 2013 Jan Sorgalla; Licensed MIT */
        ...
        if($('div.options').length)
        {
            ...
            $('#addtocard').click(function () {
                ...
                if (form.find('a.selected').length) {
                    lines.each(function () {
                        var t = $(this), link = t.find('a'), variant = link.data('id'), amount = +t.find('input').val();
            ...
            if (id !== showMP4video_activeId) {
                ...
                if (typeof url == 'string' && url != '') {
                    ...
                    $('#image-video > .video-box').html(text).css({
                        ...
                        opacity: 0,
                        height: 0,
                        'min-height': h + 'px' }).animate({
                            height: h + 'px',
                            opacity: .5
                        }, 1000, function () {
                            $(this).css({ opacity: 1, 'min-height': 0, height: 'auto' });
                        });
    ...
    $(function () {
        ...
        $('#cl_overlay, #cl_form_close').live('click', function () {
            $('#cl_form').animate({ top: '-1000px' }, 500, function () {
    ...
    $(document).ready(function () {
        ...
        $('.desc-info').jScrollPane({ showArrows: false,
                                      scrollbarWidth: 12 });
    });
