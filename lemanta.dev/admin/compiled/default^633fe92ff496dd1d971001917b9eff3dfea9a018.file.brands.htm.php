<?php /* Smarty version Smarty-3.1.8, created on 2016-09-13 15:44:36
         compiled from "/var/www/lemanta/data/www/lemanta.com/admin/design/common_parts/brands.htm" */ ?>
<?php /*%%SmartyHeaderCode:182521881957d7f4b4d08311-37200300%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '633fe92ff496dd1d971001917b9eff3dfea9a018' => 
    array (
      0 => '/var/www/lemanta/data/www/lemanta.com/admin/design/common_parts/brands.htm',
      1 => 1462406572,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '182521881957d7f4b4d08311-37200300',
  'function' => 
  array (
    'show_brands' => 
    array (
  ...
  'unifunc' => 'content_57d7f4b4e3fb19_04171041',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57d7f4b4e3fb19_04171041')) {function content_57d7f4b4e3fb19_04171041($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/lemanta/data/www/lemanta.com/Smarty/libs/plugins/function.math.php';
?>

  <?php if (isset($_smarty_tpl->tpl_vars['items']->value)&&!empty($_smarty_tpl->tpl_vars['items']->value)){?>
    <?php $_smarty_tpl->_capture_stack[0][] = array('default', "object_id", null); ob_start(); ?>BRANDS<?php echo smarty_function_math(array('equation'=>"rand(1, 100000000)"),$_smarty_tpl);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php if (!function_exists('smarty_template_function_show_brands')) {
    function smarty_template_function_show_brands($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['show_brands']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php if (isset($_smarty_tpl->tpl_vars['selector']->value)&&($_smarty_tpl->tpl_vars['selector']->value===true)){?><option value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['c']->value->brand_id, ENT_QUOTES, 'UTF-8');?>
"<?php if (isset($_smarty_tpl->tpl_vars['currents']->value)&&((is_array($_smarty_tpl->tpl_vars['currents']->value)&&in_array($_smarty_tpl->tpl_vars['c']->value->brand_id,$_smarty_tpl->tpl_vars['currents']->value))||(!is_array($_smarty_tpl->tpl_vars['currents']->value)&&($_smarty_tpl->tpl_vars['c']->value->brand_id==$_smarty_tpl->tpl_vars['currents']->value)))){?> selected<?php }?><?php if (!$_smarty_tpl->tpl_vars['c']->value->enabled||($_smarty_tpl->tpl_vars['c']->value->products_count<1)){?> class="<?php if ($_smarty_tpl->tpl_vars['c']->value->products_count<1){?>empty <?php }?><?php if (!$_smarty_tpl->tpl_vars['c']->value->enabled){?>disabled<?php }?>"<?php }?>><?php if (isset($_smarty_tpl->tpl_vars['smarty']->value['section']["spaces"])) unset($_smarty_tpl->tpl_vars['smarty']->value['section']["spaces"]);
...
<?php if (isset($_smarty_tpl->tpl_vars['counter']->value)&&($_smarty_tpl->tpl_vars['counter']->value===true)){?> [<?php echo $_smarty_tpl->tpl_vars['c']->value->products_count;?>
 шт.]<?php }?></option><?php if (isset($_smarty_tpl->tpl_vars['c']->value->subbrands)&&!empty($_smarty_tpl->tpl_vars['c']->value->subbrands)){?><?php smarty_template_function_show_brands($_smarty_tpl,array('items'=>$_smarty_tpl->tpl_vars['c']->value->subbrands,'level'=>$_smarty_tpl->tpl_vars['level']->value+1,'topic'=>$_smarty_tpl->tpl_vars['this_topic']->value));?>
<?php }?><?php }else{ ?><li<?php if (isset($_smarty_tpl->tpl_vars['c']->value->subbrands)&&!empty($_smarty_tpl->tpl_vars['c']->value->subbrands)){?> class="root"<?php }?><?php if ((!isset($_smarty_tpl->tpl_vars['flatlist']->value)||($_smarty_tpl->tpl_vars['flatlist']->value!==true))&&isset($_smarty_tpl->tpl_vars['c']->value->subbrands)&&!empty($_smarty_tpl->tpl_vars['c']->value->subbrands)){?> onmouseover="javascript: Switch_<?php echo $_smarty_tpl->tpl_vars['object_id']->value;?>
('<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['c']->value->brand_id, ENT_QUOTES, 'UTF-8');?>
...
" title="Удалить" onclick="javascript: return confirm('Данный бренд будет удален с сайта. Вы подтверждаете такую операцию?');"><img class="microkey_right" src="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['themeAdmin'][0][0]->themeAdmin(array(),$_smarty_tpl);?>
...
images/icon_hidden<?php if ($_smarty_tpl->tpl_vars['c']->value->hidden!=1){?>_off<?php }?>_16x16.png"></a><?php }?><?php }?><?php if (isset($_smarty_tpl->tpl_vars['counter']->value)&&($_smarty_tpl->tpl_vars['counter']->value===true)&&isset($_smarty_tpl->tpl_vars['c']->value->products_count)){?><span<?php if ($_smarty_tpl->tpl_vars['c']->value->products_count<1){?> class="empty" title="Не содержит товаров"<?php }else{ ?> class="count" title="Содержит <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['c']->value->products_count, ENT_QUOTES, 'UTF-8');?>
...
</span><?php }?><?php if (isset($_smarty_tpl->tpl_vars['flatlist']->value)&&($_smarty_tpl->tpl_vars['flatlist']->value===true)){?><?php if (isset($_smarty_tpl->tpl_vars['c']->value->subbrands)&&!empty($_smarty_tpl->tpl_vars['c']->value->subbrands)&&(count($_smarty_tpl->tpl_vars['c']->value->subbrands)>0)){?><span class="nesting" title="Содержит <?php echo count($_smarty_tpl->tpl_vars['c']->value->subbrands);?>
 вложенных"><?php echo count($_smarty_tpl->tpl_vars['c']->value->subbrands);?>
...
</span><?php }?><?php if (isset($_smarty_tpl->tpl_vars['currents']->value)&&((is_array($_smarty_tpl->tpl_vars['currents']->value)&&in_array($_smarty_tpl->tpl_vars['c']->value->brand_id,$_smarty_tpl->tpl_vars['currents']->value))||(!is_array($_smarty_tpl->tpl_vars['currents']->value)&&($_smarty_tpl->tpl_vars['c']->value->brand_id==$_smarty_tpl->tpl_vars['currents']->value)))){?><?php if ($_smarty_tpl->tpl_vars['c']->value->highlighted){?><b><?php }?><?php echo htmlspecialchars(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['c']->value->name), ENT_QUOTES, 'UTF-8');?>
...
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['c']->value->brand_id, ENT_QUOTES, 'UTF-8');?>
_<?php echo $_smarty_tpl->tpl_vars['level']->value;?>
_info"><div class="param">название<div class="value"><?php if (isset($_smarty_tpl->tpl_vars['fulledit']->value)&&($_smarty_tpl->tpl_vars['fulledit']->value===true)){?><input name="name[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['c']->value->brand_id, ENT_QUOTES, 'UTF-8');?>
...
<?php }?></div></div><div class="param">url<div class="value"><?php if (isset($_smarty_tpl->tpl_vars['fulledit']->value)&&($_smarty_tpl->tpl_vars['fulledit']->value===true)){?><input name="url[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['c']->value->brand_id, ENT_QUOTES, 'UTF-8');?>
...
<?php }?></div></div><div class="param">субдомен<div class="value"><?php if (isset($_smarty_tpl->tpl_vars['fulledit']->value)&&($_smarty_tpl->tpl_vars['fulledit']->value===true)){?><input name="subdomain[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['c']->value->brand_id, ENT_QUOTES, 'UTF-8');?>
...
<?php }?></div></div><div class="param">title<div class="value"><?php if (isset($_smarty_tpl->tpl_vars['fulledit']->value)&&($_smarty_tpl->tpl_vars['fulledit']->value===true)){?><input name="meta_title[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['c']->value->brand_id, ENT_QUOTES, 'UTF-8');?>
...
<?php }?></div></div><div class="param">keywords<div class="value"><?php if (isset($_smarty_tpl->tpl_vars['fulledit']->value)&&($_smarty_tpl->tpl_vars['fulledit']->value===true)){?><input name="meta_keywords[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['c']->value->brand_id, ENT_QUOTES, 'UTF-8');?>
...
<?php }?></div></div><div class="param">description<div class="value"><?php if (isset($_smarty_tpl->tpl_vars['fulledit']->value)&&($_smarty_tpl->tpl_vars['fulledit']->value===true)){?><input name="meta_description[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['c']->value->brand_id, ENT_QUOTES, 'UTF-8');?>
...
<?php }?></div></div><div class="param">вес<div class="value"><?php if (isset($_smarty_tpl->tpl_vars['fulledit']->value)&&($_smarty_tpl->tpl_vars['fulledit']->value===true)){?><input name="order_num[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['c']->value->brand_id, ENT_QUOTES, 'UTF-8');?>
...
<?php }?></div></div><div class="param">id<div class="value"><?php echo (($tmp = @htmlspecialchars($_smarty_tpl->tpl_vars['c']->value->brand_id, ENT_QUOTES, 'UTF-8'))===null||$tmp==='' ? "&nbsp;" : $tmp);?>
<?php if (isset($_smarty_tpl->tpl_vars['fulledit']->value)&&($_smarty_tpl->tpl_vars['fulledit']->value===true)){?><input class="submit" name="post[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['c']->value->brand_id, ENT_QUOTES, 'UTF-8');?>
]" type="submit" value="ok"><?php }?></div></div></div><?php }?><?php if (isset($_smarty_tpl->tpl_vars['c']->value->subbrands)&&!empty($_smarty_tpl->tpl_vars['c']->value->subbrands)){?><ul<?php if (!isset($_smarty_tpl->tpl_vars['flatlist']->value)||($_smarty_tpl->tpl_vars['flatlist']->value!==true)){?> id="<?php echo $_smarty_tpl->tpl_vars['object_id']->value;?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['c']->value->brand_id, ENT_QUOTES, 'UTF-8');?>
_<?php echo $_smarty_tpl->tpl_vars['level']->value;?>
" style="display: none; position: absolute; z-index: 1;"<?php }?>><?php smarty_template_function_show_brands($_smarty_tpl,array('items'=>$_smarty_tpl->tpl_vars['c']->value->subbrands,'level'=>$_smarty_tpl->tpl_vars['level']->value+1,'topic'=>$_smarty_tpl->tpl_vars['this_topic']->value));?>
</ul><?php }?></li><?php }?>
      <?php } ?>
    ...
    <?php smarty_template_function_show_brands($_smarty_tpl,array('items'=>$_smarty_tpl->tpl_vars['items']->value,'level'=>0,'topic'=>''));?>
